...
const MAIN_STORY=[
  ...
  {id:'ch8',icon:'🌪️',title:'九幽裂隙',summary:'裂隙镇压，无面战魂，天机老人道破最后一步。',realm:8,
   steps:[
     ...
     {type:'story',id:'m8s3',title:'无面战魂',go:'quests',
      lines:['镇压进行到一半，裂隙深处飘出一具无面战魂——它没有五官，却在你面前停住，抬手比了个「问心」的手势。','「它是三百年前第一个以身填裂隙的人，填到连脸都忘了。」战魂低声道，「它在等一个人，替它记住自己是谁。」'],
      opts:[
        {txt:'🤝 握住它的手，替它记下名字',cls:'primary',fx:{merit:5,insight:1,once:'m8s3_a',flag:{faceVow:1}}},
        {txt:'🪧 将你的名字写在它铠甲上',fx:{karma:-1,luck:1,flag:{faceVow:2}}},
      ]},
     ...
     {type:'story',id:'m8s5',title:'天机棋局',go:'quests',
      lines:['临别前，天机老人从袖中取出一副残棋：「星图刻痕你已见过。这副棋局与裂隙九重结构同源——落一子，天机便泄一分。」','他落下一枚白子，棋盘上竟浮起你与天道的倒影：「渡劫那日，天道会落九子。你要记得，第一子，是问心。」'],
      opts:[
        {txt:'♟️ 与他对弈一局',cls:'primary',fx:{insight:1,luck:1,flag:{heavenChess:1},once:'m8s5_a'}},
        {txt:'📜 拓下棋局，留待渡劫参详',fx:{insight:1,merit:2}},
      ]},
   ]},
